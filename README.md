...
Available patches:  
  ...
  • Secrets of the Shadows:  
    - Replaces localization to make startup messages from the mod empty when entering a world (mod code is hidden)  
  ...
  • KZ的视觉效果前置 (KZ_VisualMod, library for Luminous Water Reflection 潮之韵(Demo) and Shape of Light 光之形):  
    - Overrides forced White lighting to your preferred mode (mod code is hidden)  
  • Rain Overhaul:  
